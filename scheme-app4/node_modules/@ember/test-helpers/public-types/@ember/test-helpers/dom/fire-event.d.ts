...
export declare type KeyboardEventType = typeof KEYBOARD_EVENT_TYPES[number];
...
export declare type MouseEventType = typeof MOUSE_EVENT_TYPES[number];
...
export declare type FileSelectionEventType = typeof FILE_SELECTION_EVENT_TYPES[number];
