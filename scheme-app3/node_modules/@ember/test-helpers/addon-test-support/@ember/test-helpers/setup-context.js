...
import { getWarningsForContext, getWarningsDuringCallbackForContext } from './-internal/warnings';
...
const globalObject = check(typeof globalThis == 'object' && globalThis) || check(typeof window === 'object' && window) || check(typeof self === 'object' && self) || check(typeof global === 'object' && global);
...
export const SetUsage = new WeakMap();
...
*/
export default function setupContext(base, options = {}) {
  let context = base;
