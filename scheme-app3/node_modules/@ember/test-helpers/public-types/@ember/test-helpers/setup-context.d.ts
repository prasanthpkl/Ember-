...
import { DeprecationFailure } from './-internal/deprecations';
import { Warning } from './-internal/warnings';
export declare type BaseContext = object;
/**
...
export declare const ComponentRenderMap: WeakMap<object, true>;
export declare const SetUsage: WeakMap<object, string[]>;
/**
...
*/
export default function setupContext<T extends object>(base: T, options?: {
    resolver?: Resolver;
