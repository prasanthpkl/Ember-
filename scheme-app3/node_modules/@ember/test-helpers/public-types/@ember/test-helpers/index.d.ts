import { Backburner, DeferredActionQueues } from '@ember/runloop/-private/backburner';
...
export type { BaseContext, DeprecationFailure, TestContext, Warning, } from './setup-context';
...
declare module '@ember/runloop' {
    ...
    const _backburner: PrivateBackburner;
}
